...
//		if ( $handle = opendir( JPATH_SITE.DS . $_temp )) {
        	...
        	for( $count=0; $count<$numRows; $count++ ) {
				...
				$html .= '" data="' . $browserpath . 'dewplayer.swf?son=' . $mosConfig_live_site . '/' . $_temp . '/' . $file . '&amp;autoplay=0&amp;autoreplay=0" type="application/x-shockwave-flash">  <param value="' . $browserpath . 'dewplayer.swf?son=' . $mosConfig_live_site . '/' . $_temp . DS . $file . '&amp;autoplay=0&amp;autoreplay=0" name="movie"/><param value="';
